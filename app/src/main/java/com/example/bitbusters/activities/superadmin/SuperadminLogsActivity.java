...
public class SuperadminLogsActivity extends AppCompatActivity {
    ...
    private static final String TAG_COMPANY_NORTH = "empresa:miraflores";
    private static final String TAG_COMPANY_SUR = "empresa:surco";
    ...
    private void seedLogs() {
        ...
        allLogs.addAll(Arrays.asList(
                new LogItem(1, TYPE_RESERVATION, STATUS_CONFIRMED, "14:50 hrs", "Reserva registrada en proyecto Malecon 28", "asesor.miraflores@inmo.pe", "Accion Especifica", "Se registro separacion de unidad D-1204", "Recurso Afectado", "Reserva #R-2143 - S/ 5,000", "Empresa: Inmobiliaria Miraflores | Cliente: DNI 74211233", tags(TAG_STATUS_CONFIRMED, "modulo:reservas", TAG_COMPANY_NORTH)),
                ...
                new LogItem(3, TYPE_APPOINTMENT, STATUS_CONFIRMED, "14:15 hrs", "Asistencia a cita confirmada", "cliente@correo.com", "Accion Especifica", "Cliente asistio y asesor cerro visita", "Recurso Afectado", "Cita #C-9921 - 21/04 16:00", "Proyecto: Condominio Pueblo Libre", tags(TAG_STATUS_CONFIRMED, TAG_MODULE_APPOINTMENTS, "empresa:pueblolibre")),
                new LogItem(4, TYPE_ENABLEMENT, STATUS_CONFIRMED, "13:59 hrs", "Asesor habilitado por superadmin", "superadmin@inmoapp.com", "Accion Especifica", "Cambio de estado a habilitado", "Detalle del Cambio", "Asesor ID 145: Pendiente -> Activo", "Empresa: Inmobiliaria San Isidro", tags(TAG_STATUS_CONFIRMED, "modulo:habilitaciones", "empresa:sanisidro")),
                new LogItem(5, TYPE_PAYMENT, STATUS_FAILED, "13:44 hrs", "Pago rechazado por banco emisor", "pasarela-pagos@inmoapp", "Accion Especifica", "Intento de cobro fallido", "Recurso Afectado", "Pago #P-8824 - S/ 4,500", "Reserva #R-2138 | Motivo: Fondos insuficientes", tags(TAG_STATUS_FAILED, TAG_MODULE_PAYMENTS, "empresa:lamolina")),
                ...
                new LogItem(7, TYPE_RESERVATION, STATUS_FAILED, "13:28 hrs", "Reserva cancelada por vencimiento", "sistema@inmoapp", "Accion Especifica", "Expiracion por falta de pago en 10 min", "Recurso Afectado", "Reserva #R-2133", "Empresa: Inmobiliaria Surco | Estado final: Cancelada", tags(TAG_STATUS_FAILED, "modulo:reservas", TAG_COMPANY_SUR)),
                new LogItem(8, TYPE_APPOINTMENT, STATUS_FAILED, "12:57 hrs", "Bloqueo por cruce de horario de cita", "cliente2@correo.com", "Accion Especifica", "Se rechazo agenda por superposicion", "Detalle del Cambio", "Cliente ID 588 sin cambio de agenda", "Proyecto: Malecon 28 | Franja: 18:00", tags(TAG_STATUS_FAILED, TAG_MODULE_APPOINTMENTS, TAG_COMPANY_NORTH)),
                new LogItem(9, TYPE_APPOINTMENT, STATUS_CONFIRMED, "12:41 hrs", "Asistencia a cita confirmada", "asesor.sanisidro@inmo.pe", "Accion Especifica", "Check-in exitoso de cliente en sala de ventas", "Recurso Afectado", "Cita #C-9877 - 21/04 12:30", "Proyecto: Torres del Sol San Isidro | Duracion: 42 min", tags(TAG_STATUS_CONFIRMED, TAG_MODULE_APPOINTMENTS, "empresa:sanisidro")),
                new LogItem(10, TYPE_ENABLEMENT, STATUS_SUSPENDED, "12:30 hrs", "Administrador suspendido temporalmente", "superadmin@inmoapp.com", "Accion Especifica", "Bloqueo temporal de cuenta", "Detalle del Cambio", "Admin ID 33: Activo -> Suspendido", "Empresa: Inmobiliaria La Molina | Motivo: Auditoria", tags(TAG_STATUS_SUSPENDED, "modulo:habilitaciones", "empresa:lamolina")),
                new LogItem(11, TYPE_RESERVATION, STATUS_CONFIRMED, "11:45 hrs", "Nueva separacion con valoracion del asesor", "asesor.surco@inmo.pe", "Accion Especifica", "Cliente dejo valoracion y observacion", "Recurso Afectado", "Reserva #R-2125 - Valoracion: 4/5", "Comentario: Buena atencion, resolver dudas de entrega", tags(TAG_STATUS_CONFIRMED, "modulo:reservas", TAG_COMPANY_SUR)),
                new LogItem(12, TYPE_PAYMENT, STATUS_CONFIRMED, "11:20 hrs", "Pago de separacion aprobado", "pasarela-pagos@inmoapp", "Accion Especifica", "Cobro exitoso en checkout", "Recurso Afectado", "Pago #P-8801 - S/ 6,200", "Reserva #R-2119 | Empresa: Inmobiliaria Miraflores", tags(TAG_STATUS_CONFIRMED, TAG_MODULE_PAYMENTS, TAG_COMPANY_NORTH))
        ));
    }
